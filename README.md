...
این پروژه تحت سیاست "All Rights Reserved" قرار دارد. به عبارت دیگر، همهٔ حقوق متعلق به مالک پروژه است و هرگونه استفاده، بازتولید، توزیع یا تغییر نیاز به اجازهٔ کتبی دارد.
---